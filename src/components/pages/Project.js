    ...
    <div className="container-fluid">
      <div className="row">
        ...
        <div className="col-md-10 project">
          ...
          <h1>Projects</h1>
          <p>
            <a href="https://hdarden.github.io/INTown/" target="blank" alt="explore charlotte"><strong>INTown</strong></a> is a front end web app that allows users from Charlotte, NC to explore
            ...
            <p>
              <a href="https://fast-beach-51043.herokuapp.com/" target="blank" alt="assignment scheduler"><strong>School Spot</strong></a> utilizes both front-end and
          ...
          <p>
            <a href="google.com" target="blank"><strong>Schedule-Me</strong></a> is a React.js web app that allows the user to login in and schedule appointments.
          ...
          <p>
            <a href="https://github.com/hdarden/Burger-Logger" target="blank" alt="burger log"><strong>The Burger Logger</strong></a> represents my first full stack web app. It implements MySQL, Express, Handlebars, and a homemade ORM
          to allow the user to create a burger, add it the the burger logger, and choose a burger to devour.
          </p>
          <p>
            <a href="https://github.com/hdarden/Team-Profile-Gen" target="blank" alt="CLI employee DB"><strong>Team Profile Generator</strong></a> is a Node CLI that uses npm inquirer to take in information about 
          ...
          <p>
            <a href="https://hdarden.github.io/Weather-Dashboard/" target="blank"><strong>Weather Dashboard</strong></a> utilizes the OpenWeather API to retrieve data for searched cites. This app features HTML and CSS that is 
